 ...
 * @package App\Http\Controllers\V1\Ticket
 */
class TicketController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    public function findAllTicket(Request $request): JsonResponse
    {
        try {
            ...
            if (!empty($searchString)) {
                ...
                $result = $this->service->findAllTicket($limit, $orderBy);
            }
        ...
        // $teste = TicketResource::collection($response);
